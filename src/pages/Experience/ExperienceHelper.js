export const jobList = [
    {
        title:"Lead Frontend/WebGL Developer",
        company:"SpaceLab",
        dates:"Oct. 2022 - Present",
        description: [
          "Lead WebGL team, organize and administer project strategy and workflow", 
          "Build new features from visual designs and wireframes", 
          "Design and build 3D web app to render NASA and CalTech data on over 9,000 Exoplanets"
        ]
    },
    {
        title:"Web Developer",
        ...
        description: [
          "Design and implement strategies for web growth i.e. website design, Search Engine Optimization, marketing",
